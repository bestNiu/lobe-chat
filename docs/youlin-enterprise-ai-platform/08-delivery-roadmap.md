...
W13-16  制度/SOP 助手、只读 Tool、低风险 Workflow
...
- 2 个部门、20～50 名员工；
- 50～200 份制度/SOP，加上受控数量的个人知识文件和 AI 产出物；
...
| M8 灯塔闭环 | W16 | SOP 助手 + Tool + Workflow + 资源归档 + 审计 |
...
9. 选择 2 个 Pilot 部门、50～200 份知识、受控个人文件、1 个只读 Tool 和 1 个低风险 Workflow；
