...
- Membership 角色、工作流、数据 Scope、有效期和委托；
- 我的项目、项目成员和项目资源入口；
- 项目全局上下文与角色化视图；
- PM、管理层、成员权限 Facet；
- 项目关闭、成员退出和只读归档；
...
建议采用稳定核心平台团队 18～30 FTE，临床场景、数据接入和客户交付使用独立 Feature Team。24～36 个月累计投入必须在 Stage 1 Pilot 指标、场景商业价值、基础设施方案和内部/外包结构冻结后重估，不建议当前给出单一承诺数字。
