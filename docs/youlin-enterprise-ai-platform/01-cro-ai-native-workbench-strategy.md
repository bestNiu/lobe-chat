...
- 公司组织架构、法人/事业部/部门/项目组关系；参考 路径 app/unionclinRag/unionclinHub/docs/youlin-enterprise-ai-platform/know/有临组织架构-人员职责版_副本.png
- 现有 HR、OA、ERP、CRM、CTMS、EDC、eTMF、QMS、LMS、PV、安全数据库和财务系统；（HR 是新人新事，OA是泛微 在这个系统里面打算重塑流程系统，CRM是自己的系统，ctms,edc,iwars,etmf是医渡科技的有临定制产品，财务系统是用友）
