...
本轮只修订规划。每个 Spec 必须有独立设计记录和证据状态，使用 plan/05 模板；Spec approved、代码 merged、环境 verified、业务 accepted、released 五种事实分开保存。详细设计采用[工作区双轴状态](./specs/README.md)；111 项已有草案不代表批准，其余 48 项仅设计排期。未决项不得通过批量填“已完成”关闭。
