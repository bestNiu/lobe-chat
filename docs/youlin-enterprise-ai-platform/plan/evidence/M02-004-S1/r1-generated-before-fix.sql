...
CREATE UNIQUE INDEX "youlin_persons_id_enterprise_unique" ON "youlin_persons" USING btree ("id","enterprise_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "youlin_subjects_id_enterprise_unique" ON "youlin_subjects" USING btree ("id","enterprise_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "youlin_identity_audit_id_enterprise_unique" ON "youlin_identity_audit_events" USING btree ("id","enterprise_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "youlin_identity_commands_id_enterprise_unique" ON "youlin_identity_commands" USING btree ("id","enterprise_id");--> statement-breakpoint
