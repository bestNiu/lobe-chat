...
> 65 项详细草案，94 项仅设计排期；全部未批准、未开发。角色均待实名认领。详见[滚动计划](../07-detailed-spec-design-plan.md)与[catalog](./catalog.json)。
...
| [M11](./M11/README.md) | 14 | 1 | W3～W5，领域 UI 滚动 | W5～W6 骨架；规则 W8 | W22 |
...
M10 的 4 项草案覆盖 C0 核心与后续切片边界，不代表 W20 的全部实现细节已完成；M11 仅统一 Review 核心已展开。M04 多端一致性须随资源/记忆/Context 交付补真实测试，W8 不签尚未存在的能力。
